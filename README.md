...
# [Проект Дашборд по взаимодействию пользователей с карточками статей](https://public.tableau.com/views/Ya_dashbord_16532114866970/Dashboard1?:language=en-US&:display_count=n&:origin=viz_share_link)
Необходимо было создать дашборд с определенным набором данных, графиков и фильтров
...
# [Проект Формирование модели монетизации в игровом приложении](https://github.com/Ruzhaya/Data_analysis_projects/blob/main/Final_project.ipynb)
Необходимо провести исследование и составить рекомендации по запуску рекламы в игровом приложении.

Основной датасет содержит данные о событиях, совершенных в мобильной игре. Предполагается, что в приложении будет происходить показ рекламы на экране с выбором типа объекта для постройки. Представлены данные по игре на первом уровне, завершение уровня требует от игрока одного из двух условий:
* Победа над первым врагом;
* Реализация проекта - разработка орбитальной сборки спутников.

Данные когорт с 4 по 10 мая включительно.
...
* `event` - одно из трех событий:
    ...
    * `finished_stage_1` - первый уровень завершен
    * `project` - проект завершен
* `building type` - один из трех типов здания:
...
`ad_cost.csv`
* `day` - день, в который был совершён клик по объявлению
